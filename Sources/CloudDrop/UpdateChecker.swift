...
final class UpdateChecker {
    ...
    func checkForUpdate() async {
        do {
            var request = URLRequest(
                url: URL(string: "https://api.github.com/repos/colachg/CloudDrop/releases/latest")!)
            ...
            if Self.isNewer(remote: remoteVersion, than: currentVersion) {
                ...
                downloadAssetURL = release.assets
                    .first(where: { $0.name == "CloudDrop.app.zip" })
    ...
    private func downloadAndInstall(from url: URL) async {
        ...
        do {
            ...
            let zipPath = tempDir.appendingPathComponent("CloudDrop.app.zip")
